...
/* build-hook-start *//*00001*/try { require('/Users/mac/.vscode/extensions/wallabyjs.console-ninja-1.0.533/out/buildHook/index.js').default({tool: 'next.js', checkSum: '200e047856e2a50e46cc03AVMeBhkPDwEDV1MGBVUFUwBTUwoD', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/mac/.vscode/extensions/wallabyjs.console-ninja-1.0.533/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '200e047856e2a50e46cc03AVMeBhkPDwEDV1MGBVUFUwBTUwoD', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
